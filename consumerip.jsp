                ...
                <div class="header">
                    ...
                    <div class="h_right">
                        <ul class="menu">
                            ...
                            <li><a href="notverify.jsp">Consumer Block</a></li>
                    ...
                    <div class="content">
                        ...
                        <div class="blog_left" style="height: 800px;overflow-y: auto">	
                            <table>
                                ...
                                <tr>
                                    <td><%=resultSet1.getString("mail")%></td>
                                </tr>
                                <tr>
                                    <td><a href="Update.jsp?mail=<%=resultSet1.getString("mail")%>"><input type="button" value="Block"></a></td>
                                </tr>
                                <br><br>
                                <%                                }%>
                            </table>
