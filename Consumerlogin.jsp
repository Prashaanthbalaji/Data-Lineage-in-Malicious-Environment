                ...
                <div class="header">
                    ...
                    <div class="h_right">
                         <ul class="menu">
                            ...
                            <li class="active"><a href="Consumerlogin.jsp">Consumer Login</a></li>
                            ...
                            <div class="cont-grid">
                                ...
                                <form action="login1" method="post">
                                    <table style="margin-left: 79px;margin-top: 56px">
                                        <tr>
                                            <td>
                                                <input type="text" name="user" placeholder="Enter your mail id" style="margin-left: 1px;width:330px;color: black;font-size: large;height:24px;border:  1px solid orange" required="" >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
