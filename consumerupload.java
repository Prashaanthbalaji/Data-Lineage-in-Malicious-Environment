 ...
 * @author vinoth
 */
@WebServlet(urlPatterns = {"/consumerupload"})
public class consumerupload extends HttpServlet {
...
// Process the uploaded items
            ...
            while (iter.hasNext()) {
                ...
                if (item.isFormField()) {
                    ...
                    if (name.equalsIgnoreCase("tag")) {
                        ...
                        owner = value;
                        out.print("From value is : " + owner);
                    } else if (name.equalsIgnoreCase("userid")) {
                        mail = value;
                        out.print("From value is : " + mail);
                    } else if (name.equalsIgnoreCase("url")) {
                        url = value;
                        out.print("From value is : " + url);
                    } else {
            ...
            try {
                ...
                st = con.prepareStatement("insert into ad(file,tag,userid,time,fname,owner,url) values (?,?,?,?,?,?,?)");
                if (file != "") {
                    st.setBinaryStream(1, (InputStream) fis, (int) (ff.length()));
                } else {
