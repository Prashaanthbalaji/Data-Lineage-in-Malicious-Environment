<%-- 
    Document   : Friends
    Created on : Aug 18, 2015, 3:30:15 PM
    Author     : sivakumar
--%>
<%-- 
                ...
                <div class="main">
                    <div class="content">
                        ...
                        <div class="blog_left">		
                            <div class="blog_main">
                                <%
                                    getname.name n = new getname.name();
                                    try {
                                        ...
                                        while (resultSet1.next()) {
                                            getname.name1 n1 = new getname.name1();
                                %>
                                <div style="height: 50px;width: 50px;">
                                    ...
                                    <table>
                                        ...
                                        <td style="position: absolute"><span><a href=""><input type="button" value="Friends " style="font-weight: 600;float: right;border: medium none;outline: medium none;display: inline-block;padding: 12px 30px;font-size: 0.8925em;color: #FFF;background: #19BD9B none repeat scroll 0% 0%;text-transform: uppercase;border-radius: 2px;transition: all 0.3s ease-in-out 0s;margin-left: 262px;cursor: inherit;margin-top: -77px"></a></span></td>
                                        <td style="color: white"><%=n1.rsiva(resultSet1.getString("fromid"))%></td>    
                                        </tr>
                                    </table>
                                ...
                                <div style="height: 50px;width: 50px;">
                                    ...
                                    <table>
                                        <tr>
                                            <td><img src="retrive.jsp?id=<%=resultSet2.getString("toid")%>" height="60" width="50" style="border: 1px solid black;height: 103px;width: 123px"></td>
                                            <td style="alignment-adjust: central;position: absolute"><h2 style="margin-left: 66px;margin-top:-69px"><%=n.rsiva(resultSet2.getString("toid"))%></h2><h2 style="color:white"><%=n1.rsiva(resultSet2.getString("toid"))%></h2></td>
                                        <input type="hidden" value="<%=resultSet2.getString("toid")%>" name="toid">                         
                                        <input type="hidden" name="fromid" value="<%=session.getAttribute("userid")%>">
                                        <td style="position: absolute"><span><a href=""><input type="button" value="Friends " style="font-weight: 600;float: right;border: medium none;outline: medium none;display: inline-block;padding: 12px 30px;font-size: 0.8925em;color: #FFF;background: #19BD9B none repeat scroll 0% 0%;text-transform: uppercase;border-radius: 2px;transition: all 0.3s ease-in-out 0s;margin-left: 262px;cursor: inherit;margin-top: -77px"></a></span></td>
