                ...
                <div class="header">
                    ...
                    <div class="h_right">
                        <ul class="menu">
                            ...
                            <li><a href="notverify.jsp">Not verified ads</a></li>
                            <li><a href="consumerip.jsp">Consumer Block</a></li>
                    ...
                    <div class="content">
                        ...
                        <div class="blog_left" style="height: 800px;overflow-y: auto">	
                            ...
                            <div class="blog_main">	
                                ...
                                <div class="b_right">
                                    ...
                                    <div class="blog_list">             
                                        <ul>
                                            ...
                                            <li><a href="#"> <i class="v"> </i><span>124 views</span></a></li>
                                        </ul>
                                        <div class="clear"></div>
                                    </div>
                                    <div class="blog_art">
                                ...
                                <div class="clear"></div>
                                <a href="<%=resultSet1.getString("url")%>"><img src="addisplay.jsp?id=<%=resultSet1.getString("id")%>" alt=""/></a>
                                    <%
